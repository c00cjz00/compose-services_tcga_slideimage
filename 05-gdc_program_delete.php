<?php
// 輸入
// https://google-gen4.biobank.org.tw//api/v0/submission/
$program=trim($argv[1]);
$project=trim($argv[2]);
...
delete_data($url_Origin,$url_Target,$url_Referer,$token);
...
function delete_data($url_Origin,$url_Target,$url_Referer,$token){
        $cmd="curl '".$url_Target."' \
-X 'DELETE' \
